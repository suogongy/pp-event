package org.ppj.pp.event.core.xxljob.model;
...
public class XxlJobInfo {
	...
	private String scheduleType = "FIX_RATE";			// 调度类型
	private String scheduleConf = "60";			// 调度配置，值含义取决于调度类型
	private String misfireStrategy = "DO_NOTHING";			// 调度过期策略

	private String executorRouteStrategy = "ROUND";	// 执行器路由策略
	...
	private long triggerLastTime = 0;	// 上次调度时间
	private long triggerNextTime = 0;	// 下次调度时间
