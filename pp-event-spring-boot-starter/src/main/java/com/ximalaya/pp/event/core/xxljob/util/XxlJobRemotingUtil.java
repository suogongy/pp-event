...
import org.ppj.pp.event.core.xxljob.util.GsonTool;
...
public class XxlJobRemotingUtil {
    private static Logger logger = LoggerFactory.getLogger(org.ppj.pp.event.core.xxljob.util.XxlJobRemotingUtil.class);
