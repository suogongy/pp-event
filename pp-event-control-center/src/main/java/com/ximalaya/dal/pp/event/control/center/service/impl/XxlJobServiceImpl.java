...
import org.ppj.dal.pp.event.control.center.core.cron.CronExpression;
...
import org.ppj.dal.pp.event.control.center.core.model.XxlJobLogReport;
...
import org.ppj.dal.pp.event.control.center.core.thread.JobScheduleHelper;
import org.ppj.dal.pp.event.control.center.core.util.I18nUtil;
import org.ppj.dal.pp.event.control.center.dao.*;
...
public class XxlJobServiceImpl implements XxlJobService {
	...
	public ReturnT<String> save(XxlJobInfo jobInfo) {
		...
		// valid base
		XxlJobGroup group = xxlJobGroupDao.findByAppname(jobInfo.getAppname());
		if (group == null) {
			return new ReturnT<String>(ReturnT.FAIL_CODE, (I18nUtil.getString("system_please_choose")+I18nUtil.getString("jobinfo_field_jobgroup")) );
		}
