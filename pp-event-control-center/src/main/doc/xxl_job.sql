...
(
    ...
    `executor_handler`          varchar(150)          DEFAULT NULL COMMENT '执行器任务handler',
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `i_group_executor_handler` (`job_group`,`executor_handler`) USING BTREE
...
) ENGINE = InnoDB COMMENT='任务日志统计报告表';
...
(
    ...
    `update_time` datetime    DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB COMMENT='任务日志glue信息表';

CREATE TABLE `xxl_job_registry`
(
    `id`             int(11)      NOT NULL AUTO_INCREMENT COMMENT '主键id',
    `registry_group` varchar(50)  NOT NULL COMMENT '执行器信息',
    `registry_key`   varchar(150) NOT NULL COMMENT '注册key',
    `registry_value` varchar(150) NOT NULL COMMENT '注册value',
    `update_time`    datetime DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`id`),
    KEY `i_g_k_v` (`registry_group`, `registry_key`, `registry_value`)
) ENGINE = InnoDB COMMENT='任务注册信息表';

CREATE TABLE `xxl_job_group`
(
    `id`           int(11)     NOT NULL AUTO_INCREMENT COMMENT '主键id',
    `app_name`     varchar(100) NOT NULL COMMENT '执行器AppName',
